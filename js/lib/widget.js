...
Widget.initWidget = function (el) {
    ...
    require.async(['../widget/' + widget[0]], function (require) {
        //console.log(Fn);
        var Fn = require('../widget/' + widget[0]);
        var instance;
        if (widget[1]) {
            Fn = Fn[widget[1]];
        }
...
Widget.initWidget = function (widget) {
    $.each(widget.elements, function(index, el){
        var $el = $(el);
        var config = $el.data();
        var roles = {};
        //var widget = config.widget.split('#');
    ...
    /*console.log(widget[0]);
    require.ensure(['../widget/' + widget[0]], function (require) {
        //console.log(Fn);
        var Fn = require('../widget/' + widget[0]);
        var instance;
        if (widget[1]) {
